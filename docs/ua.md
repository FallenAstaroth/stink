...
- `features` - вмикає модулі зі списку.
...
Передавайте, якщо потрібно увімкнути тільки певні модулі. Модулі для списку можна імпортувати з `stink.enums.Features`.

- `utils` - вмикає утиліти зі списку.
