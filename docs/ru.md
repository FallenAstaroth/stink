...
### С помощью BAT
1. Загружаем [компилятор](https://github.com/FallenAstaroth/stink/releases/download/v1.2.1/compiler.bat).
...
6. Перейдите во вкладку `Режимы`, нажмите `Распаковать во временную папку` и выберите `Скрыть все` в разделе `Режим вывода информации`.
